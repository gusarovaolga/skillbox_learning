    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            try {
                ...
                logger.log(Level.INFO, "Станция отправления: " + from.getName());
                Station to = takeStation("Введите станцию назначения:");
                logger.log(Level.INFO, "Станция назначения: " + to.getName());
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (line.matches("[A-Za-z]+")) {
                throw new IllegalArgumentException("English font: " + line);
            }
            if (line.matches("[0-9]+")) {
            ...
            logger.log(Level.ERROR, "Станция не найдена: " + line);
